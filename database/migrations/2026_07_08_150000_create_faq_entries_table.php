...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $admin = [
            ...
            ['Qual è la differenza tra "App in costruzione" e "Sito in manutenzione"?', 'costruzione manutenzione differenza toggle', '"App in costruzione" blocca solo le notifiche reali agli ospiti (il sito resta visitabile). "Sito in manutenzione" blocca invece l\'accesso a tutto il sito per i visitatori.', '/admin/sviluppo', 'Vai a Sviluppo'],
            ['Come attivo o disattivo il sito in manutenzione?', 'manutenzione attiva disattiva', 'Vai su Admin → Sviluppo e usa l\'interruttore "Sito in manutenzione".', '/admin/sviluppo', 'Vai a Sviluppo'],
            ['Come vedo il sito vero durante la manutenzione?', 'accesso bypass manutenzione password link', 'Usa il link personale oppure il login "Accesso team" (email + password) mostrati nella pagina di manutenzione stessa, sotto l\'interruttore in Sviluppo.', '/admin/sviluppo', 'Vai a Sviluppo'],
            ...
            ['Cosa sono le prove con etichetta "auto" in Prova flusso?', 'copie automatiche test manutenzione', 'Sono copie di test create automaticamente quando arriva una prenotazione reale durante la manutenzione, per farti provare l\'app in sicurezza. Si cancellano da sole dopo 5 giorni.', '/admin/prova', 'Vai a Prova flusso'],
