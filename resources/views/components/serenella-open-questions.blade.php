@php
    $openQuestions = \Database\Seeders\AppGuideSeeder::openQuestionsForSerenella();
@endphp
<div class="bg-amber-50 border border-amber-200 rounded-[2rem] p-5 shadow-sm">
    <h2 class="text-sm font-black text-amber-950 uppercase tracking-tight mb-2">Domande per Serenella</h2>
    <p class="text-xs text-amber-900/80 mb-3">
        ...
        (filtro «Richieste Serenella» / domande aperte). Rispondi sotto ogni task.
    </p>
